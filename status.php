...
if ($login_type == "Mitra") {
    ...
    if (isset($_POST["simpan_status"])) {
        ...
        $_SESSION['pesan_sukses'] = "Status pesanan #$id_pesanan telah diperbarui.";
        header("Location: status.php"); exit;
    }
}
...
<head>
    ...
    <style> .badge.new { font-weight: 500; border-radius: 8px; } </style>
</head>
<body>
                ...
                <div class="card-action" style="background-color: #f9f9f9;">
                    <?php if ($pesanan['berat'] == NULL) : // TAHAP KONFIRMASI BERAT ?>
                        <form action="" method="post" class="row valign-wrapper" style="margin-bottom:0;">
                            ...
                            <div class="input-field col s8 m5"><input type="number" step="0.1" name="berat_aktual" placeholder="Contoh: 3.5" required><label>Berat Aktual (Kg)</label></div>
                        ...
                        <form action="" method="post" class="row valign-wrapper" style="margin-bottom:0;">
                            ...
                            <div class="input-field col s8 m5">
                                <select name="status_pesanan">
                                    ...
                                    <option value="Proses Pengeringan" <?= $pesanan['status_pesanan'] == 'Proses Pengeringan' ? 'selected' : '' ?>>Pengeringan</option>
                            ...
                            <div class="col s4 m7"><button class="btn green" type="submit" name="simpan_status">Update Status</button></div>
                        </form>
                    <?php endif; ?>
                </div>
            </div>
