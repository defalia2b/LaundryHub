            ...
            <div class="col s6 offset-s3">
                <div class="card">
                    <div class="col center" style="margin:20px">
                        <img src="img/laundryhub_logo_transparent.png" alt="laundryhub" width=100%/><br><br>
                    ...
                    <div class="card-content">
                        ...
                        <p>2.	Mitra memiliki nama usaha serta logo perusahaan agar dapat diposting di website LaundryHub</p>
                        ...
                        <p>9.	Mitra tidak diperkenankan untuk melakukan kerjasama dengan pihak Laundry lainnya</p>
                        <p>10.	Sebagai kompensasi atas kerjasama adalah sistem bagi hasil sebesar 5%, yang diperhitungkan dari setiap 7 hari</p>
                        <p>11.	Status mitra secara otomatis dicabut apabila melanggar kesepakatan yang telah ditetapkan dalam surat perjanjian kerjasama ataupun mitra ingin mengundurkan diri</p>
                    </div>
                    <div class="card-action">
                        <a href="index.php">HOME - LAUNDRYHUB</a>
                    </div>
                </div>
            </div>
        </div>
